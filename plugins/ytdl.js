  ...
  try {
    ...
    _0x5351f6.ev.on("messages.upsert", async _0x11c496 => {
      ...
      if (_0x3cf2a8) {
        ...
        });//https://api.giftedtech.my.id/api/download/dlmp3?apikey=gifted&url=
        const _0x1cc9d0 = await fetchJson('https://apitest1-f7dcf17bd59b.herokuapp.com/download/ytmp3?url=' + _0x5ed25e);//https://api.giftedtech.my.id/api/download/dlmp3q?apikey=gifted&quality=128&url= //https://api.giftedtech.my.id/api/download/ytmp3v2?apikey=gifted&url=https://youtu.be/qHDJSRlNhVs?feature=shared // https://api.giftedtech.my.id/api/download/ytmp3v2?apikey=gifted&url=
        const _0x5741ec = _0x1cc9d0.result.download_url; //https://apitest1-f7dcf17bd59b.herokuapp.com/download/ytmp3?url=
        await _0x5351f6.sendMessage(_0x3277a3, {
