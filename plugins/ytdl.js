  ...
  try {
    ...
    _0x5351f6.ev.on("messages.upsert", async _0x11c496 => {
      ...
      if (_0x3cf2a8) {
        ...
        const _0x1cc9d0 = await fetchJson('https://api.davidcyriltech.my.id/youtube/mp3?url=' + _0x5ed25e);//https://api.giftedtech.my.id/api/download/dlmp3q?apikey=gifted&quality=128&url=
